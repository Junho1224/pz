...
', 'Break-in');
insert into articles (id, board_id, user_id, content, title) VALUES (71982, 1, 4, '제1항의 탄핵소추는 국회재적의원 3분의 1 이상의 발의가 있어야 하며, 그 의결은 국회재적의원 과반수의 찬성이 있어야 한다.
', 'Twister');
insert into articles (id, board_id, user_id, content, title) VALUES (61162, 2, 7, '비상계엄하의 군사재판은 군인·군무원의 범죄나 군사에 관한 간첩죄의 경우와 초병·초소·유독음식물공급·포로에 관한 죄중 법률이 정한 경우에 한하여 단심으로 할 수 있다.
', 'Trekkies 2');
...
', 'Hi-Line, The');
insert into articles (id, board_id, user_id, content, title) values (676534, 1, 10, '국회는 상호원조 또는 안전보장에 관한 조약, 중요한 국제조직에 관한 조약, 우호통상항해조약, 주권의 제약에 관한 조약,
...
', 'Flintstones, The');
insert into articles (id, board_id, user_id, content, title) VALUES (7332927, 2, 14, '체포·구속·압수 또는 수색을 할 때에는 적법한 절차에 따라 검사의 신청에 의하여 법관이 발부한 영장을 제시하여야 한다.
', 'Frogmen, The');
insert into articles (id, board_id, user_id, content, title) values (12704, 1, 15, '국가원로자문회의의 조직·직무범위 기타 필요한 사항은 법률로 정한다.
', 'Just Bea (Bare Bea)');
insert into articles (id, board_id, user_id, content, title) VALUES (1453879, 1, 8, '대통령·국무총리·국무위원·행정각부의 장·헌법재판소 재판관·법관·중앙선거관리위원회 위원·감사원장·감사위원
', 'Evil Bong');
...
', 'At the Circus');
insert into articles (id, board_id, user_id, content, title) VALUES (271346, 1, 11, '제1항의 탄핵소추는 국회재적의원 3분의 1 이상의 발의가 있어야 하며, 그 의결은 국회재적의원 과반수의 찬성이 있어야 한다.
', 'Lady Jane');
...
', 'Straw Dogs');
insert into articles (id, board_id, user_id, content, title) VALUES (500039, 2, 14, '대법원장의 임기는 6년으로 하며, 중임할 수 없다. 국가는 국민 모두의 생산 및 생활의 기반이 되는 국토의 효율적이고 균형있는 이용·개발
', 'Mala Noche');
insert into articles (id, board_id, user_id, content, title) values (641261, 2, 6, '대통령은 내우·외환·천재·지변 또는 중대한 재정·경제상의 위기에 있어서 국가의 안전보장 또는 공공의 안녕질서를 유지하기 위하여 긴급한 조치가 필요하고 국회의
...
', 'House of Mirth, The');
insert into articles (id, board_id, user_id, content, title) values (18652, 1, 12, '체포·구속·압수 또는 수색을 할 때에는 적법한 절차에 따라 검사의 신청에 의하여 법관이 발부한 영장을 제시하여야 한다.
